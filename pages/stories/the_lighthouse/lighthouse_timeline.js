...
const SCENES = [
    ...
    { id: 1, act: 'act1', title: 'Arrival on Pilot Rock', types: ['establishing', 'atmosphere'],
      ...
      symbols: ['foghorn', 'seagulls', 'lighthouse', 'fog'], callbacks: [], foreshadowing: [5, 12, 41] },
    ...
    { id: 2, act: 'act1', title: 'First Night - Exploration', types: ['character', 'mystery'],
      ...
      symbols: ['mermaid carving', 'locked desk', 'chamber pot'], callbacks: [], foreshadowing: [8, 22, 35] },
    ...
    { id: 3, act: 'act1', title: 'The Foghorn & Furnace', types: ['labor', 'atmosphere'],
      ...
      symbols: ['foghorn', 'fire', 'coal', 'liquor'], callbacks: [], foreshadowing: [27] },
    ...
    { id: 4, act: 'act1', title: 'The First Supper', types: ['conflict', 'power'],
      ...
      symbols: ['toast/prayer', 'the light', 'cistern', 'regulations'], callbacks: [], foreshadowing: [12, 32] },
    ...
    { id: 5, act: 'act1', title: 'Old Alone with the Light', types: ['mystery', 'obsession'],
      ...
      symbols: ['the light', 'fresnel lens', 'obsession', 'tattoos'], callbacks: [], foreshadowing: [11, 39, 40] },
    ...
    { id: 6, act: 'act1', title: 'First Vision - Log Drive', types: ['hallucination', 'foreshadowing'],
      ...
      symbols: ['logs', 'drowning man', 'mermaid', 'cant hook', 'mackinaw coat'], callbacks: [], foreshadowing: [29, 33], isHallucination: true },
    ...
    { id: 7, act: 'act1', title: 'Monotonous Labor', types: ['labor', 'montage'],
      ...
      symbols: ['wheelbarrow', 'one-eyed gull', 'cistern', 'labor'], callbacks: [], foreshadowing: [12, 17] },
    ...
    { id: 8, act: 'act1', title: 'Young Watches Old', types: ['voyeurism', 'mystery'],
      ...
      symbols: ['mermaid carving', 'the light', 'voyeurism', 'silhouette'], callbacks: [5], foreshadowing: [11, 27] },
    ...
    { id: 9, act: 'act1', title: 'Swab, Dog!', types: ['conflict', 'power'],
      ...
      symbols: ['power', 'dog', 'obedience', 'brasswork'], callbacks: [4], foreshadowing: [36] },
    ...
    { id: 10, act: 'act1', title: 'Whitewashing the Tower', types: ['danger', 'labor'],
      ...
      symbols: ['one-eyed gull', 'fall', 'tower', 'whitewash'], callbacks: [7], foreshadowing: [40] },
    ...
    { id: 11, act: 'act1', title: 'Demands Access to Light', types: ['conflict', 'revelation'],
      ...
      symbols: ['brass keys', 'the light', 'locked door', 'oil drum'], callbacks: [5], foreshadowing: [38, 39] },
    ...
    { id: 12, act: 'act1', title: 'Bad Luck to Kill a Seabird', types: ['mythology', 'warning'],
      ...
      symbols: ['seagull', 'superstition', 'the light', 'previous keeper'], callbacks: [7], foreshadowing: [17, 41] },
    ...
    { id: 13, act: 'act2', title: 'Names Exchanged', types: ['bonding', 'dialogue'],
      ...
      symbols: ['identity', 'timber', 'past', 'connection'], callbacks: [], foreshadowing: [29, 33] },
    ...
    { id: 14, act: 'act2', title: 'Cigarette Goes Out', types: ['omen', 'supernatural'],
      ...
      symbols: ['cigarette', 'curse', 'omen', 'superstition'], callbacks: [], foreshadowing: [17, 29] },
    ...
    { id: 15, act: 'act2', title: 'Spying - Tentacles', types: ['hallucination', 'horror', 'voyeurism'],
      ...
      symbols: ['tentacles', 'the light', 'voyeurism', 'slime'], callbacks: [5, 8], foreshadowing: [37], isHallucination: true },
    ...
    { id: 16, act: 'act2', title: 'Killing the One-Eyed Gull', types: ['violence', 'turning point'],
      ...
      symbols: ['one-eyed gull', 'cistern', 'violence', 'blood'], callbacks: [7, 12], foreshadowing: [17, 41], isViolence: true },
    ...
    { id: 17, act: 'act2', title: 'The Wind Changes', types: ['supernatural', 'consequence'],
      ...
      symbols: ['weathervane', 'wind', 'curse', 'east wind'], callbacks: [12, 16], foreshadowing: [18, 19] },
    ...
    { id: 18, act: 'act2', title: 'Last Night Before Relief', types: ['bonding', 'celebration'],
      ...
      symbols: ['lobster', 'drinking', 'shanties', 'relief'], callbacks: [4], foreshadowing: [20, 21] },
    ...
    { id: 19, act: 'act2', title: 'Tender Doesn\'t Come', types: ['dread', 'isolation'],
      ...
      symbols: ['storm', 'isolation', 'tender', 'waiting'], callbacks: [17], foreshadowing: [20, 24] },
    ...
    { id: 20, act: 'act2', title: 'Calming the Sea', types: ['mythology', 'ritual'],
      ...
      symbols: ['Neptune', 'ritual', 'ninth wave', 'Blood Red Roses'], callbacks: [12], foreshadowing: [26] },
    ...
    { id: 21, act: 'act2', title: 'Time Distorts', types: ['horror', 'psychological'],
      ...
      symbols: ['time', 'madness', 'provisions', 'confusion'], callbacks: [19], foreshadowing: [24] },
    ...
    { id: 22, act: 'act2', title: 'Digging Up Liquor', types: ['dark comedy'],
      ...
      symbols: ['grave', 'liquor', 'burial', 'digging'], callbacks: [2], foreshadowing: [35, 38] },
    ...
    { id: 23, act: 'act2', title: 'Mermaid on the Rocks', types: ['hallucination', 'horror', 'sexuality'],
      ...
      symbols: ['mermaid', 'sexuality', 'death', 'seaweed'], callbacks: [6], foreshadowing: [27], isHallucination: true },
    ...
    { id: 24, act: 'act3', title: 'Drinking and Fighting', types: ['chaos', 'violence', 'bonding'],
      ...
      symbols: ['drinking', 'violence', 'shanties', 'destruction'], callbacks: [18], foreshadowing: [30, 36], isViolence: true },
    ...
    { id: 25, act: 'act3', title: 'Almost a Kiss', types: ['intimacy', 'tension'],
      ...
      symbols: ['intimacy', 'ballad', 'repression', 'homoeroticism'], callbacks: [18], foreshadowing: [37] },
    ...
    { id: 26, act: 'act3', title: 'Neptune\'s Curse', types: ['mythology', 'horror', 'conflict'],
      ...
      symbols: ['Neptune', 'Triton', 'curse', 'sea king'], callbacks: [12, 20], foreshadowing: [41] },
    ...
    { id: 27, act: 'act3', title: 'Mermaid Visions', types: ['hallucination', 'violence', 'sexuality'],
      ...
      symbols: ['mermaid carving', 'tentacles', 'sexuality', 'destruction'], callbacks: [6, 8, 23], foreshadowing: [33], isHallucination: true, isViolence: true },
    ...
    { id: 28, act: 'act3', title: 'Head in Lobster Pot', types: ['hallucination', 'horror'],
      ...
      symbols: ['lobster pot', 'one-eyed corpse', 'previous keeper', 'crabs'], callbacks: [7, 12], foreshadowing: [32], isHallucination: true },
    ...
    { id: 29, act: 'act3', title: 'Young\'s Confession', types: ['revelation', 'confession'],
      ...
      symbols: ['identity', 'murder by inaction', 'confession', 'logs'], callbacks: [6, 13, 14], foreshadowing: [33, 37], isRevelation: true },
    ...
    { id: 30, act: 'act3', title: 'Old\'s Eyes Shine', types: ['hallucination', 'horror', 'supernatural'],
      ...
      symbols: ['doppelganger', 'the light', 'transformation', 'mackinaw coat'], callbacks: [5, 6], foreshadowing: [40], isHallucination: true },
    ...
    { id: 31, act: 'act3', title: 'Lifeboat Destroyed', types: ['violence', 'entrapment'],
      ...
      symbols: ['axe', 'lifeboat', 'entrapment', 'life vest'], callbacks: [19], foreshadowing: [38, 39], isViolence: true },
    ...
    { id: 32, act: 'act3', title: 'Accusation of Murder', types: ['confrontation'],
      ...
      symbols: ['mermaid carving', 'accusation', 'previous keeper', 'madness'], callbacks: [2, 12, 28], foreshadowing: [] },
    ...
    { id: 33, act: 'act3', title: 'Gaslighting', types: ['psychological', 'manipulation'],
      ...
      symbols: ['identity', 'gaslighting', 'reality', 'manipulation'], callbacks: [29], foreshadowing: [35] },
    ...
    { id: 34, act: 'act3', title: 'Thieves\' Oil', types: ['dark comedy', 'desperation'],
      ...
      symbols: ['turpentine', 'honey', 'madness', 'laughter'], callbacks: [22], foreshadowing: [38] },
    ...
    { id: 35, act: 'act3', title: 'Reading the Logbook', types: ['revelation', 'betrayal'],
      ...
      symbols: ['logbook', 'betrayal', 'truth', 'severance'], callbacks: [2, 9], foreshadowing: [36], isRevelation: true },

    { id: 36, act: 'act3', title: 'You\'re a Liar!', types: ['confrontation', 'rage'],
      location: 'INT. Galley',
      time: 'Morning',
      summary: 'Young EXPLODES: "I\'m sick of yer lies, yer farts, yer smell—like rotten dick, like curdled foreskin, like hot onions fucked a farmyard shit-house! You ain\'t my FATHER!" Old smiles creepily: "Ye\'re a painted actress cryin\' bout the silver spoon what should\'ve been yers. Will y\'kill me like y\'done that gull? \'Twas YE what damned us, DOG! A DOG, Thomas! A FILTHY DOG!"',
      symbols: ['father', 'dog', 'truth', 'rage'], callbacks: [9, 29], foreshadowing: [37] },
    ...
    { id: 37, act: 'act3', title: 'Tentacle Fight', types: ['hallucination', 'violence', 'climax'],
      ...
      symbols: ['tentacles', 'mermaid', 'Winslow', 'transformation'], callbacks: [6, 15, 23, 25, 27], foreshadowing: [38], isHallucination: true, isViolence: true },
    ...
    { id: 38, act: 'act3', title: 'Buried Alive', types: ['violence', 'horror', 'revenge'],
      ...
      symbols: ['grave', 'dog', 'burial', 'prophecy'], callbacks: [9, 22, 36], foreshadowing: [39], isViolence: true },

    { id: 39, act: 'act3', title: 'Old Returns with Axe', types: ['violence', 'horror', 'murder'],
      location: 'INT. Galley',
      time: 'Moments later',
      summary: 'Young retrieves his tobacco pouch. The hole in the table is empty—THE AXE IS GONE. OLD, covered in mud, barely alive, SWINGS THE AXE INTO YOUNG\'S SHOULDER. Blood gushes. Young grabs the IRON KETTLE and BASHES Old\'s face. Then he picks up the axe... lifts it high... DRIVES IT INTO OLD\'S HEAD with a BLOOD CURDLING CRUNCH. He toasts the corpse: "Should pale death..."',
      symbols: ['axe', 'murder', 'kettle', 'toast'], callbacks: [31], foreshadowing: [40], isViolence: true },
    ...
    { id: 40, act: 'act3', title: 'Into the Light', types: ['climax', 'revelation', 'tragedy'],
      ...
      symbols: ['the light', 'fresnel lens', 'Prometheus', 'fall', 'brass keys'], callbacks: [5, 10, 11, 30], foreshadowing: [], isRevelation: true },
    ...
    { id: 41, act: 'act3', title: 'Prometheus Punished', types: ['ending', 'mythology', 'horror'],
      ...
      symbols: ['Prometheus', 'seagulls', 'liver', 'punishment', 'mythology'], callbacks: [1, 7, 12, 16, 17, 26], foreshadowing: [], isViolence: true }
];
...
function initVisualization() {
    ...
    // Node labels - moved further from node (16px instead of 12px) and made clickable
    nodes.append('text')
        ...
        .text(d => `${d.data.id}. ${d.data.title.length > 20 ? d.data.title.substring(0, 20) + '...' : d.data.title}`);
...
function initLegend() {
    ...
    const connectionTypes = [
        { label: 'Foreshadowing', color: '#5a8b5a', style: 'solid', desc: 'Scene sets up later events' },
        { label: 'Callback', color: '#8b5a8b', style: 'dashed', desc: 'Scene references earlier events' },
        { label: 'Thematic', color: '#b8860b', style: 'solid', desc: 'Shared symbols/motifs' }
    ];
